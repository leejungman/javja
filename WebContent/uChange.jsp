...
function changeForm_check() {
 ...
 /*  var idCheck = /^(?=.*[a-zA-Z])(?=.*[!@#$%^*+=-])(?=.*[0-9]).{4,10}$/;
  ...
  //입력 값 전송
  document.changefrom.submit(); //유효성 검사의 포인트   
}

function id_check(){
	window.open('idCheck.jsp','','width=400,height=400');
	
}

function pw_help () {
	
	window.open('pwHelp.jsp','','width=650,height=100');
...
<form name="changefrom" action="uChangeAction.jsp?userID=<%=userID %>" method="post">
  <div>
 <h3 style="text-align: center;">"회원 수정"</h3>
					...
					<div class="form-group">
						<input type="password" class="" placeholder="비밀번호"
							name="userPassword" maxlength="20" id="userPassword" value=<%=user.getUserPassword()%>>
							<button type="button" onclick="pw_help();">비밀번호도움말</button>
					</div>
					<div class="form-group">
						<input type="password" class="" placeholder="비밀번호체크"
							name="userPasswordCheck" maxlength="20" id="userPasswordCheck" value="">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<input type="text" class="" placeholder="이메일"
							 maxlength="20" id="userEmail1" value=""> @
					...
					<div class="form-group">
						...
						<input type="text" class="" placeholder="전화번호"
							maxlength="4" id="userPhone2">&nbsp;&nbsp;&nbsp;-&nbsp;
						<input type="text" class="" placeholder="전화번호"
							maxlength="4" id="userPhone3">
						<input type="hidden" name="userPhone" id="userPhone">
							
					</div>
					<div class="form-group">
						<input type="text" class="" placeholder="우편번호"
							name="userZipCode" maxlength="10" id="userZipCode">
  ...
  <div class="join_btn">
    ...
    <button type="button" onclick="changeForm_check();" class="btn btn-primary pull-right">가입하기</button>
